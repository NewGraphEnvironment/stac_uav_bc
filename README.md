...
to document and serve out UAV imagery collected in British Columbia as
a [SpatioTemporal Asset Catalog (STAC)](https://stacspec.org/)
collection, organized by region / watershed-group / year. Queryable by
location via the
...
# build a download / preview table — split the asset URL into
...
Browse [open issues](https://github.com/NewGraphEnvironment/stac_uav_bc/issues)
