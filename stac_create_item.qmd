...
<!-- NOTE: routine item creation is now scripted — use scripts/stac_create_item.py
(additive-only, skips existing ids). This qmd remains for prototyping and the
full-rebuild chunks. See scripts/config/README.md for the add-imagery recipe. -->
